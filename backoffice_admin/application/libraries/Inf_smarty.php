...
class Inf_smarty extends Smarty {
	...
	function view($template, $data = array(), $return = FALSE)
	{
		...
		if ($return == FALSE)
		{
			$default_src = "default-src 'self' https://pci-connect.squareup.com/* https://va.tawk.to/ https://api.qrserver.com/ https://www.youtube.com/;";
			$connect_src = "connect-src 'self' https://pci-connect.squareup.com/* wss://ws.blockchain.info/inv https://*.tawk.to/ wss://*.tawk.to/ https://api.qrserver.com/ ;";
			$script_src = "script-src *  'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://www.statcounter.com https://embed.tawk.to https://ajax.googleapis.com https://code.jquery.com https://fullcalendar.io;";
			$style_src = "style-src 'self'  'unsafe-inline' 'unsafe-eval' https://fonts.googleapis.com/ https://cdn.jsdelivr.net/ https://cdnjs.cloudflare.com;";
			$font_src = "font-src 'self' https://fonts.gstatic.com https://*.tawk.to/ https://cdnjs.cloudflare.com;";
