<?php
/* Smarty version 3.1.30, created on 2020-08-10 12:57:25
  from "/home/mbatradingacadem/public_html/office/backoffice_admin/application/views/admin/profile/profile_view.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5f30b795486e56_95707115',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3d25080522ef55d5803e6ad1063d264c51dce3cf' => 
    array (
      0 => '/home/mbatradingacadem/public_html/office/backoffice_admin/application/views/admin/profile/profile_view.tpl',
      1 => 1576556392,
      2 => 'file',
    ),
  ),
...
function content_5f30b795486e56_95707115 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_8083104355f30b795485407_03314121', $_smarty_tpl->tpl_vars['CONTENT_BLOCK']->value);
?>
...
class Block_8083104355f30b795485407_03314121 extends Smarty_Internal_Block
{
...
?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['from_page']->value == 'user_account') {?>
...
echo lang('s_profile');?>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <input type="hidden" value='<?php echo $_smarty_tpl->tpl_vars['age_limit']->value;?>
' name="age_limit" id="age_limit">
                <input type="hidden" value='<?php echo $_smarty_tpl->tpl_vars['u_name']->value;?>
' name="profile_user" id="profile_user">
                <input type="hidden" name="current_update_section" id="current_update_section" value="<?php echo $_smarty_tpl->tpl_vars['current_update_section']->value;?>
">
                <input type="hidden" id="site_url" value="<?php echo $_smarty_tpl->tpl_vars['SITE_URL']->value;?>
">
...
"/>
                    <div class="edit_button"> 
                        <img align="left" class="fb-image-profile thumbnail" src="<?php echo $_smarty_tpl->tpl_vars['SITE_URL']->value;?>
...
/admin/edit_profile" type="submit" class="btn btn-sm btn-primary"><?php echo lang('edit_profile');?>
</a>
                            </div>
            ...
            <div class="tab" id="personal_info">
                <div class="content" id="personal_info_div">
                    <div class="wrapper-md">
                        <i class="fa fa-edit"id="edit_personal_info" style="font-size:20px;color:#23b7e5;float:right;"></i>
                    </div>
                    <div role="form" class="ng-pristine ng-valid">
                        <div class="form-group">
                            <label class="required"><?php echo lang('first_name');?>
</label>
...
" class="form-control">
                        ...
                        <div class="form-group">
                            <label class="required"><?php echo lang('gender');?>
</label>
                        ...
                        <div class="form-group">
                            <label class="required"><?php echo lang('date_of_birth');?>
</label>
...
" class="form-control">
                        ...
                        <button type="button" id="update_personal_info" class="btn btn-sm btn-primary"><?php echo lang('update');?>
</button> 
                        <button type="button" id="cancel_personal_info" class="btn btn-sm btn-info"><?php echo lang('cancel');?>
</button>
                    </div>
                </div>
            </div>
                ...
                <div class="content" id="contact_info_div">
                    ...
                    <div role="form" class="ng-pristine ng-valid">
                        <div class="form-group">
                            ...
                            <input type="text" name="address" id="address" value="<?php echo $_smarty_tpl->tpl_vars['profile_details']->value["address"];?>
" class="form-control">
                        </div>
                        <div class="form-group">
...
" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <select name="country" id="country" onChange="getAllStates(this.value, 'admin');" class="form-control"><?php echo $_smarty_tpl->tpl_vars['countries']->value;?>
</select>
                        </div>
                        <div class="form-group">
...
" class="form-control">
                        ...
                        <button type="button" id="update_contact_info" class="btn btn-sm btn-primary"><?php echo lang('update');?>
</button>
                        <button type="button" id="cancel_contact_info" class="btn btn-sm btn-info"><?php echo lang('cancel');?>
</button>
                    </div>
                </div>
            </div>
...
" class="form-control" placeholder="https://twitter.com">
                        ...
                        <button type="button" id="update_social_info" class="btn btn-sm btn-primary"><?php echo lang('update');?>
</button>
                        <button type="button" id="cancel_social_info" class="btn btn-sm btn-info"><?php echo lang('cancel');?>
</button>
                    </div>
                </div>
            </div>
...
" class="form-control">
                            ...
                            <div class="form-group">
                                <label><?php echo lang('swift_code');?>
</label>
                                <p class="form-control-static"><?php echo $_smarty_tpl->tpl_vars['profile_details']->value["swift_code"];?>
</p>
                                <input type="text" name="swift_code" id="swift_code" value="<?php echo $_smarty_tpl->tpl_vars['profile_details']->value["swift_code"];?>
" class="form-control">
                            </div>
...
" class="form-control">
                            ...
                            <button type="button" id="update_bank_info" class="btn btn-sm btn-primary"><?php echo lang('update');?>
</button>
                            <button type="button" id="cancel_bank_info" class="btn btn-sm btn-info"><?php echo lang('cancel');?>
</button>
                        </div>
                    </div>
                </div>
...
?>
                        ...
                        <button type="button" id="update_language_info" class="btn btn-sm btn-primary"><?php echo lang('update');?>
</button>
                        <button type="button" id="cancel_language_info" class="btn btn-sm btn-info"><?php echo lang('cancel');?>
</button>
                    </form>
                </div>
            </div>
