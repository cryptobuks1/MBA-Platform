...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div class="pull-right col-xs-12 col-sm-3 padding_both">
            {form_open('admin/step_view','role="form" name="search_member" id="search_member" method="post"')}
            <div class="col-sm-7 padding_both">
            ...
            <div class="pull-right col-xs-12 col-sm-5 padding_both_small">
