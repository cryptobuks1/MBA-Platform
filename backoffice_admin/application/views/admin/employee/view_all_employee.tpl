                            ...
                            {foreach from=$emp_detail item=v}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="edit_employee({$id}, '{$path}')" title="Edit" class="btn-link text-info btn_size" data-placement="top" data-original-title="{lang('edit')}"><i class="fa fa-edit"></i></a>
                                        
                                         
                                            <a href="javascript:delete_employee({$id},'{$path}')" title="Delete" class="btn-link text-danger btn_size" data-placement="top" data-original-title="{lang('edit')}"><i class="fa fa-trash-o"></i></a>
