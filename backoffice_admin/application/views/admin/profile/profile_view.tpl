    ...
    {if $profile_view_permission!='no'}
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <input type="hidden" name="current_update_section" id="current_update_section" value="{$current_update_section}">
                <input type="hidden" id="site_url" value="{$SITE_URL}">
                <input type="hidden" name="otp" id="otp" value="">
                <div class="fb-profile"> 
                     
                    <img align="left" class="fb-image-lg" src="{$SITE_URL}/uploads/images/banners/{$profile_details["banner_name"]}"/>
                    <div class="edit_button"> 
                        <img align="left" class="fb-image-profile thumbnail" src="{$SITE_URL}/uploads/images/profile_picture/{$profile_details["profile_photo"]}"/> 
                    </div>
                    <div class="col-sm-9">
                    ...
                    <div class="col-sm-12">
                        <div class="fb-profile-text_1">
                            <div class="pull-right">
                                <a href="{BASE_URL}/admin/edit_profile" type="submit" class="btn btn-sm btn-primary">{lang('edit_profile')}</a>
                            </div>
                ...
                <div class="content" id="personal_info_div">
                    ...
                    <div role="form" class="ng-pristine ng-valid">
                        <div class="form-group">
                            <label class="required">{lang('first_name')}</label>
                        ...
                        <div class="form-group">
                            <label class="required">{lang('gender')}</label>
                        ...
                        <div class="form-group">
                            <label class="required">{lang('date_of_birth')}</label>
                        ...
                        <button type="button" id="update_personal_info" class="btn btn-sm btn-primary">{lang('update')}</button> 
                        <button type="button" id="cancel_personal_info" class="btn btn-sm btn-info">{lang('cancel')}</button>
                    </div>
                </div>
            </div>
                ...
                <div class="content" id="contact_info_div">
                    ...
                    <div role="form" class="ng-pristine ng-valid">
                        <div class="form-group">
                            ...
                            <input type="text" name="address" id="address" value="{$profile_details["address"]}" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="country" id="country" onChange="getAllStates(this.value, 'admin');" class="form-control">{$countries}</select>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="button" id="update_contact_info" class="btn btn-sm btn-primary">{lang('update')}</button>
                        <button type="button" id="cancel_contact_info" class="btn btn-sm btn-info">{lang('cancel')}</button>
                    </div>
                </div>
            </div>
                ...
                <div class="content" id="social_info_div">
                    ...
                    <div role="form" class="ng-pristine ng-valid">
                        <div class="form-group">
                            ...
                            <input type="text" name="facebook" id="facebook" value="{$profile_details["facebook"]}" class="form-control" placeholder="https://facebook.com">
                        </div>
                        <div class="form-group">
                            <label>{lang('twitter')}</label>
                            <p class="form-control-static">{$profile_details["twitter"]}</p>
                            <input type="text" name="twitter" id="twitter" value="{$profile_details["twitter"]}" class="form-control" placeholder="https://twitter.com">
                        </div>
                        <button type="button" id="update_social_info" class="btn btn-sm btn-primary">{lang('update')}</button>
                        <button type="button" id="cancel_social_info" class="btn btn-sm btn-info">{lang('cancel')}</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content" id="bank_info_div">
                        ...
                        <div role="form" class="ng-pristine ng-valid">
                            ...
                            <div class="form-group">
                                ...
                                <p class="form-control-static">{$profile_details["swift_code"]}</p>
                                <input type="text" name="swift_code" id="swift_code" value="{$profile_details["swift_code"]}" class="form-control">
                            </div>
                            ...
                            <button type="button" id="update_bank_info" class="btn btn-sm btn-primary">{lang('update')}</button>
                            <button type="button" id="cancel_bank_info" class="btn btn-sm btn-info">{lang('cancel')}</button>
                        </div>
                    </div>
                </div>
            {/if}
            ...
            <div class="tab" id="language_info">
                <div class="content" id="language_info_div">
                    ...
                    <form role="form" class="ng-pristine ng-valid">
                        ...
                        <button type="button" id="update_language_info" class="btn btn-sm btn-primary">{lang('update')}</button>
                        <button type="button" id="cancel_language_info" class="btn btn-sm btn-info">{lang('cancel')}</button>
                    </form>
                </div>
            </div>
            {/if}
