                    ...
                    {include file="layout/error_box.tpl"} 
                        <div class="form-group">
                            <label class="control-label" for="txtDefaultHtmlArea">{lang('main_matter')}</label>
                                <textarea class="ckeditor form-control"  id="content_terms"  name="content_terms" title="{lang('main_matter')}"  rows="6">{if isset($content['upgrade_note'])}{$content['upgrade_note']}{else}
                        ...
                        <div class="form-group">
                            <button class="btn btn-sm btn-primary"  name="submit_upgrade_text" id="submit_upgrade_text" type="submit" value="{lang('update')}" > {lang('update')}</button>
                        </div>
                    </div>   
