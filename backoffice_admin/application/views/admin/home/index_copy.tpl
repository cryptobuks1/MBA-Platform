            ...
            <div class="row row-sm text-center">
                ...
                <div class="col-xs-6" id="section_tile1">
                    <div class="panel padder-v item">
                        ...
                        <span class="text-muted text-xs">{lang('business_summery')}</span>
                ...
                <div class="col-xs-6" id="section_tile2">
                    <div class="panel padder-v item bg-primary">
                        ...
                        <span class="text-muted text-xs">{lang('total_commission_paid')}</span>
                ...
                <div class="col-xs-6" id="section_tile4">
                    <div class="panel padder-v item">
                        ...
                        <span class="text-muted text-xs">{lang('total_profit_date')}</span>
                        <div class="top text-right w-full">
                ...
                <ul class="list-group list-group-lg m-b-none">
                    ...
                    {foreach from=$top_earners item=j}
                        <li class="list-group-item">
                            ...
                            <span class="pull-right text-muted inline m-t-sm">{$j['balance_amount']}</span>
