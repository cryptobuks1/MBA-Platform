<div class="" id="edit_lead_div">
        ...
        <div class="form-group">
            <label for="start_time" >{lang("start_time")}</label>
                ...
                <input   class="form-control date-picker" name="task_date"  autocomplete="off" value="{$date}" id="input-task_date" type="text"  >
                {form_error('task_date')}
            </div>
            <div class="form-group">
             <label for="start_time" >{lang('date')}</label>
