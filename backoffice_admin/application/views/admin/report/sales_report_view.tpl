{extends file=$BASE_TEMPLATE} {block name=$CONTENT_BLOCK}{assign var="excel_url" value="{$BASE_URL}admin/excel/create_excel_sales_report/{$product_type}"} {assign var="csv_url" value="{$BASE_URL}admin/excel/create_csv_sales_report/{$product_type}"}
