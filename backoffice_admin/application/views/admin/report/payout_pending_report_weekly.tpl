{extends file=$BASE_TEMPLATE} {block name=$CONTENT_BLOCK}{assign var="excel_url" value="{$BASE_URL}admin/excel/create_excel_payout_pending_report"} {assign var="csv_url" value="{$BASE_URL}admin/excel/create_csv_payout_pending_report"}
{assign var="report_name" value="{lang('member_wise_payout_report')}"}{include file="admin/report/report_nav.tpl" name=""}
