{extends file=$BASE_TEMPLATE} {block name=$CONTENT_BLOCK}{assign var="excel_url" value="{$BASE_URL}admin/excel/create_excel_repurchase_report"} {assign var="csv_url" value="{$BASE_URL}admin/excel/create_csv_repurchase_report"}
{assign var="report_name" value="{lang('repurchase_report')}"}{include file="admin/report/report_nav.tpl" name=""}
