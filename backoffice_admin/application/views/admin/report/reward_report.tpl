...
{block name=$CONTENT_BLOCK}
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <legend>
                <span class="fieldset-legend">{lang('reward_report')}<b>{if $user_name!="admin" && $user_name!=NULL}: {$user_name}{/if}</b></span>
            </legend>
                ...
                <table st-table="rowCollectionBasic" class="table table-bordered table-striped">
                    ...
                    {if count($details)>0}
                        <div class="button_back">
                            <a href="{$BASE_URL}admin/excel/create_excel_reward_report"> <button class="btn m-b-xs btn-sm btn-primary btn-addon"><i class="fa fa-file-excel-o"></i>{lang('create_excel')}</button></a>
                            <a href="{$BASE_URL}admin/excel/create_csv_reward_report"> <button class="btn m-b-xs btn-sm btn-primary btn-addon"><i class="fa fa-file-text-o"></i>{lang('create_csv')}</button></a>
                        </div>
                        <tbody>
