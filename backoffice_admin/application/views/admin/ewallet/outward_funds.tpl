...
<div class="panel-body">
    <legend>
        <span class="fieldset-legend">{lang('withdrawal_outward_fund_details')}{if $user_name}
            : {$user_name}
        {/if}</span>
    </legend>
    <div class="section-dropdown-filter" data-remote="{$BASE_URL}admin/ewallet/outward_funds" data-clear="{lang('clear')}">
