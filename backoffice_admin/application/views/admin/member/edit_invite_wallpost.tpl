                ...
                {form_open('', 'role="form" class="smart-wizard" method="post"  name="invite_text_form" id="invite_text_form"')}
                    ...
                    <div class="form-group"> 
                        <label class="control-label required" > {lang('subject')}</label>
                            <input class="form-control" type="text" name ="subject" id ="subject" value='{$mail_details['subject']}' autocomplete="Off">
                            {form_error('subject')}
                    </div>

                    <div class="form-group">
                        <label class="control-label required" for="mail_content">{lang('message')}</label>
                            <textarea id="mail_content"  name="mail_content" class="ckeditor form-control" rows='10' >{$mail_details['content']}   
                            </textarea>
...
{*                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <button class="btn m-b-xs btn-sm btn-primary btn-addon" type="submit" value="Update" name="update" id="update" >{lang('update')}</button>                               
                    </div>
                {form_close()}
            </div>
        </div>
