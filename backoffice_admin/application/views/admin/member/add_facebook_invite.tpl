            ...
            <div class="content">
                {form_open('','role="form" class="smart-wizard" method="post"  name="soial_invite_fb" id="soial_invite_fb"')}
                    ...
                    {include file="layout/error_box.tpl"}
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn m-b-xs btn-sm btn-primary btn-addon" type="submit" value="Update" name="submit_fb" id="submit_fb"><i class="fa fa-plus"></i>{lang('submit')}</button>                                                        
                        </div>
                {form_close()}
            </div>
        </div>
