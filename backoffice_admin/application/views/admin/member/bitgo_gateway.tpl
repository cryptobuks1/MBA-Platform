...
{block name=$CONTENT_BLOCK}
                            ...
                            <div class="container" style="margin:auto; background-color:#fff;">
                                <div class="row" style="margin-bottom:15px;">
                                    <div class="col-md-6">
                                        ...
                                        <div id="loading"  class="qr_code_img_1 text-center" style="padding-top: 15px;">

                                        </div>
                                        <div id="notifications" class="qr_code_img_1 text-center" style="padding-top: 15px;">
                                        ...
                                        <input type="hidden" id="path_root" name="path_root" value="{$PATH_TO_ROOT_DOMAIN}admin/member"/>
                                        <!-- <div class="timer"></div>-->
                                    </div><!---col-md-6-->
                                    <div class="col-md-6  qr_code_img m-t-xl"> {$qr_code}
                                        <div style="margin-top: 45px;">
                                            {form_open('admin/member/btc_confirm', 'role="form" class="" method="post"  name="bitgo_form" id="bitgo_form')}
                                        ...
                                        <div class="col-md-6 m-t-xl"><h3>{lang('instructions')}.</h3>
                                            1.{lang('login_to_your_bitcoin_wallet')}.
                                            <br>2.{lang('send_the_given_btc_amount_to')}  <br><code id="addressCode" class="address" tabindex="4">{$bitcoin_address}
                                            </code>
                                        </div>
                                </div>
                            </div>
    ...
    <input type="hidden" name="bitgo_verify_url" id="bitgo_verify_url" value="{$BASE_URL}admin/member/ajax_bitgo_payment_verify/">
    <input type="hidden" name="bitgo_error_url" id="bitgo_error_url" value="{$BASE_URL}/admin/member/upgrade_package_validity">
