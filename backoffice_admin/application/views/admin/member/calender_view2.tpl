...
<div id="span_js_messages" style="display:none;">
    ...
    <div id='calendar' style=" width: 700px; margin: 0 auto;"
    ></div>
                </div>
            </div>
        </div>
...
{block name=script}
  {$smarty.block.parent}
    <script src="{$PUBLIC_URL}/javascript/validate_invite_wallpost.js"></script>
      <script src="{$PUBLIC_URL}/javascript/fullcalendar/lib/jquery.min.js"></script>
        <script src="{$PUBLIC_URL}/javascript/fullcalendar/lib/moment.min.js"></script> 
        <script src="{$PUBLIC_URL}/javascript/fullcalendar/fullcalendar.min.js"></script>
</script>


<script src="https://fullcalendar.io/js/fullcalendar-2.1.1/lib/moment.min.js" type="application/javascript"></script>
<script src="https://fullcalendar.io/js/fullcalendar-2.1.1/lib/jquery.min.js" type="application/javascript"></script>
<script src="https://fullcalendar.io/js/fullcalendar-2.1.1/lib/jquery-ui.custom.min.js" type="application/javascript"></script>
<script src="https://fullcalendar.io/js/fullcalendar-2.1.1/fullcalendar.min.js" type="application/javascript"></script>
