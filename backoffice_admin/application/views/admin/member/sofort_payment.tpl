...
{block name=$CONTENT_BLOCK}
    ...
    {form_open('admin/member/sofort_response', 'method="post" class="" name="form" id="form" role="form"')}
    ...
    <div class="panel panel-default table-responsive ng-scope">
        <table st-table="rowCollectionBasic" class="table">
            ...
            <input type="hidden" name="success_url" id="success_url" value="{$PATH_TO_ROOT_DOMAIN}admin/member/sofort_success">
