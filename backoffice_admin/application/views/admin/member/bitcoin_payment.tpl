...
{block name=$CONTENT_BLOCK}
    <div class="content_section bd-bottom">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="container" style="margin:auto; background-color:#fff;">
                                    <div class="row" style="margin-bottom:15px;">
                                        ...
                                        <div class="col-md-6 qr_code_img m-t-xl"> {$qr_code}</div>
        ...
        <input type="hidden" id="check_url" value="{$PATH_TO_ROOT_DOMAIN}admin/member/bitcoin_response">
        <input type="hidden" id="success_url" value="{$PATH_TO_ROOT_DOMAIN}admin/member/bitcoin_registration">
        <input type="hidden" id="error_url" value="{$PATH_TO_ROOT_DOMAIN}admin/member/upgrade_package_validity">
    </div>
{/block}
