                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" style="margin-top: 25px;">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="qr_code_img"><img src="{$PUBLIC_URL}images/b_blockchain.png">
                                        ...
                                        <div id="notifications" class="qr_code_img_1 text-center" style="padding-top: 15px;"><img src="{$PUBLIC_URL}images/blockchain_loading.gif" width=100 height=100> <br/> {lang('waiting_for_payment')}{lang('please_do_not_refresh')}</div>
                                        <input type="hidden" id="path_root" name="path_root" value="{$PATH_TO_ROOT_DOMAIN}admin/member"/>
                                        <input type="hidden" id="redirect_path" name="redirect_path" value="{$PATH_TO_ROOT_DOMAIN}admin/member/upgrade_package_validity">
                                        <div class="timer"></div>
                                    </div><!---col-md-6-->
                                    <div class="col-md-6  qr_code_img m-t-xl"  id="qr"> {$qr_code}</div>
                                </div>
                            </div>
                        </div>
                    </div>
