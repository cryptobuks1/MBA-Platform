...
<div class="panel panel-default">
    ...
    <legend><span class="fieldset-legend">{lang('datewise_events')}</span></legend>
        {form_open('admin/calender_description','role="form" class="" method="post" name="weekly_join" id="weekly_join" target="__blank" onsubmit= "return dateValidation()"')} {include file="layout/error_box.tpl"}
