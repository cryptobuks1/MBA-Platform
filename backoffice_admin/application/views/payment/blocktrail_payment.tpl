                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="qr_code_img">
                                                    ...
                                                    <div class="but01" style="background-color: #35B89C;">
...
<input type="hidden" id="check_url" value="{$PATH_TO_ROOT_DOMAIN}upgrade/ajax_blocktrail_callback">
<input type="hidden" id="success_url" value="{$PATH_TO_ROOT_DOMAIN}upgrade/blocktrail_done">
<input type="hidden" id="error_url" value="{$PATH_TO_ROOT_DOMAIN}upgrade/package_upgrade">
