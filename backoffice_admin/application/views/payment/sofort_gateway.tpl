...
{block name=$CONTENT_BLOCK}
    ...
    {form_open('upgrade/sofort_response', 'method="post" class="" name="form" id="form" role="form"')}
    ...
    <div class="panel panel-default table-responsive ng-scope">
        <table st-table="rowCollectionBasic" class="table">
            ...
            <input type="hidden" name="success_url" id="success_url" value="{$PATH_TO_ROOT_DOMAIN}upgrade/sofort_success">
            <input type="hidden" name="abort_url"  id="abort_url" value="{$PATH_TO_ROOT_DOMAIN}upgrade/upgrade_package">
       <tr>
        {if $DEMO_STATUS == 'yes'}
