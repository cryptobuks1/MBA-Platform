...
//print_r($placement_id);die;
        ...
        if (isset($reg_status['status']) && $reg_status['status']) {
          ...
          // $this->calculation_model->calculateFastStartBonus($regr['sponsor_id']);
           ...
           // $this->plan_model->runCalculationAfterRank($action, $user_id, $product_id, $product_pv, $product_amount, $oc_order_id, $upline_id, 0, $position, $data); 
            // Referral commission
