...
require_once 'TwoFactorAuthException.php';
require_once 'Providers/Qr/GoogleQRCodeProvider.php';
require_once 'Providers/Qr/IQRCodeProvider.php';
require_once 'Providers/Rng/CSRNGProvider.php';
require_once 'Providers/Rng/MCryptRNGProvider.php';
require_once 'Providers/Rng/OpenSSLRNGProvider.php';
require_once 'Providers/Rng/HashRNGProvider.php';
require_once 'Providers/Rng/IRNGProvider.php';
...
class TwoFactorAuth {
    ...
    function __construct($issuer = null, $digits = 6, $period = 30, $algorithm = 'sha1', $qrcodeprovider = null, $rngprovider = null) {
        ...
        if ($rngprovider == null) {
            if (function_exists('random_bytes')) {
                ...
                $rngprovider = new MCryptRNGProvider();
            } elseif (function_exists('openssl_random_pseudo_bytes')) {
                $rngprovider = new OpenSSLRNGProvider();
            } elseif (function_exists('hash')) {
                $rngprovider = new HashRNGProvider();
            } else {
                throw new TwoFactorAuthException('Unable to find a suited RNGProvider');
            }
        }

        if (!($rngprovider instanceof IRNGProvider))
    ...
    /**
     * Timing-attack safe comparison of 2 codes ()
     */
