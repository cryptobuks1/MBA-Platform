...
var ajax_list_externalFile = 'employee/employee_auto';	// Path to external file
...
var text_width= $(inputObj).width();
        ...
        $("#autowidthcssemp").html("<style> #ajax_listOfOptions{ width:"+width_ajaxsearch +"px !important; } </style>");
    ...
    if (!ajax_list_cachedLists[paramToExternalFile])
    {
        ...
        ajax_list_externalFile = base_path + 'admin/' + ajax_list_externalFile;
    }
