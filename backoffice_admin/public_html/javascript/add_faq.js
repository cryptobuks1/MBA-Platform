...
function deleteFaq(element) {
   ...
   function trim(a) {
    ...
    function enable_next2() {
        $('#new_faq').attr('disabled', false);
    }

    function disable_next2() {
        $('#new_faq').attr('disabled', true);
    }
...
//                    //add message and change the class of the box and start fading
            ...
            if (error != 1) {
                var date_availability = path_root + "admin/news/ajax_is_sortorder_available";
                ...
                $.post(date_availability, { sort_order: $('#sort_order').val() }, function (data) {
