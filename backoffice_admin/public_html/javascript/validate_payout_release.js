...
// End
function inactivate_payout(id, root)
{
    var confirm_msg = $('#confirm_msg_inactivate').html();
    if (confirm(confirm_msg))
    {
        document.location.href = root + 'payout/inactivate_payout/' + id;
    }
}
function activate_payout(id, root)
{
    var confirm_msg = $('#confirm_msg_activate').html();
    if (confirm(confirm_msg))
    {
        document.location.href = root + 'payout/activate_payout/' + id;
    }
}
