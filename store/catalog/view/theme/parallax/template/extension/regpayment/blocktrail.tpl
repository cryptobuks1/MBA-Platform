<?php if ($bitcoin_address) { ?>
  ...
  <script type="text/javascript"><!--
     ...
     window.blocktrail_request = setInterval(function() {
        $.ajax({
		url: 'index.php?route=extension/regpayment/blocktrail/bitcoin_response',
		type: 'post',
		data: { bitcoin_address: "<?php echo $bitcoin_address; ?>" },
		dataType: 'json',
		cache: false,
...
window.blocktrail_timer = setInterval(function() {
...
$('#button-confirm').on('click', function() {
        $.ajax({
            type: 'post',
            url: 'index.php?route=extension/regpayment/blocktrail/blocktrail_success',
            data: { bitcoin_address: "<?php echo $bitcoin_address; ?>" },
            dataType: 'json',
            cache: false,
            beforeSend: function() {
