<div class="panel panel-default">
 ...
 <span class="estimate-title"><?php echo $text_shipping; ?></span>

      <div class="form-horizontal">
        <div class="form-group required">
          <label class="info-title control-label" for="input-country"><?php echo $entry_country; ?></label>
            <select name="country_id" id="input-country" class="form-control unicase-form-control selectpicker">
        ...
        <div class="form-group required">
          <label class="info-title control-label" for="input-zone"><?php echo $entry_zone; ?></label>
            <select name="zone_id" id="input-zone" class="form-control unicase-form-control selectpicker">
            </select>
        </div>
        <div class="form-group required">
          <label class="info-title control-label" for="input-postcode"><?php echo $entry_postcode; ?></label>
