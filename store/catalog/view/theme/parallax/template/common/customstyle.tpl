...
<?php }   ?>    
    ...
    <style type="text/css">
           ...
           h2.product-hadding,.promo-title,.free-shipping-box .hadding-title,.hadding-title{
                font-family:<?php if($wg24themeoptionpanel_heders_select_font_prallax=="show"){ echo $wg24themeoptionpanel_heders_gol_font_prallax['face']; ?> ,sans-serif <?php }else{ echo $wg24themeoptionpanel_heders_gol_font_prallax['face'];?>, sans-serif   <?php } ?>;
            }    
        </style>  
        <?php if($wg24themeoptionpanel_col_skin_prallax=="customeskin"){ ?>
        <style type="text/css">  
