            ...
            <div class="col-sm-12">
                <div class="form-group required">
                    <div id="div-same-as" class="checkbox">
                        <?php if ($same_as) { ?>
                        <input style="" type="checkbox" name="same_as" value="1" checked="checked" id="input-step5-same_as" />
                        <?php } else { ?>
                        <input style="" type="checkbox" name="same_as" value="1" id="input-step5-same_as" />
                        <?php } ?>
