    <div class="row">
        ...
        <div class="col-sm-6">
            <fieldset id="account">
                ...
                <div class="form-group required">
                    <label class="control-label" for="input-step4-dob"><?php echo $entry_dob; ?></label>
                    <input name="date_of_birth" id="date_of_birth" type="hidden"/>
                    <div class="row">
                        <div class=" col-sm-4">
                            <select name="year" id="input-step4-year" class="form-control" >
                            </select>
                        </div>
                        <div class="col-sm-4">
                            <select name="month" id="input-step4-month" class="form-control">
                            </select> 
                        </div>
                        <div class="col-sm-4">
                            <select name="day" id="input-step4-day" class="form-control" >
                            </select>
...
<script type="text/javascript">
        ...
        $(function(){
            initializeYearMonthDay('input-step4-year', 'input-step4-month', 'input-step4-day');
   ...
   function trim(a)
    ...
    $("#input-step4-password").keypress(function(e)
    {
        ...
        var re = /[0-9]/;
        if (e.which != 33 && e.which != 35 && e.which != 36 && e.which != 37 && e.which != 38 && e.which != 42 && e.which != 64 && e.which != 8 && e.which != 0 && (e.which < 48 || e.which > 57) && (e.which < 65 || e.which > 90) && (e.which < 97 || e.which > 122))
