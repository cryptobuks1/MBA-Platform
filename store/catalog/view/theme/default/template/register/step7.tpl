...
<div class="radio">
    <label>
        ...
        <input tabindex="1" type="radio" name="payment_method" value="<?php echo $payment_method['code']; ?>" checked="checked" />
        <?php } else { ?>
        <input tabindex="2" type="radio" name="payment_method" value="<?php echo $payment_method['code']; ?>" />
        <?php } ?>
...
<div class=" pull-right">
    <button tabindex="6" id="button-step7-back" class="btn btn-default" type="button"><?php echo $button_back; ?></button>
    <button tabindex="1" id="button-step7-continue" class="btn btn-primary" type="button"><?php echo $button_continue; ?></button>
</div>
</div>