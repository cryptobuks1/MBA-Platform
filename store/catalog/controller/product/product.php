...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		$this->load->language('product/product');
                ...
                // options data
                    ...
                    'wg24themeoptionpanel_p_tab_contorl_prallax',
                    'wg24themeoptionpanel_p_tab_title_prallax',
                        'wg24themeoptionpanel_p_tab_content_prallax',
                        'wg24themeoptionpanel_productlayout_prallax',
                        'wg24themeoptionpanel_home1bestsaletext_prallax',
                        'wg24themeoptionpanel_rpaddbanner_prallax'
                    ); 
		...
		$this->load->model('catalog/product');
                ...
                /* best sale */
                 $bresults = $this->model_catalog_product->getBestSellerProducts(15); 
                     $data['bproducts'] = array();
		if ($bresults) {
 ...
 if ($this->cart->getProductsCount('registration')) {
		...
		if ($product_info) {
			...
			$this->response->setOutput($this->load->view('product/quicview', $data));
		} else {
			$url = '';
