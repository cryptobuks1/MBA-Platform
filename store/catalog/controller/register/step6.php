...
class ControllerRegisterStep6 extends Controller {

    public function index() {
        $this->load->language('checkout/checkout');
        $this->load->language('register/step5');
        if (!isset($this->session->data['inf_reg_data']['step5'])) {
        ...
        $this->response->setOutput($this->load->view('register/step6', $data));
    }
    ...
    public function save() {
        ...
        if (!$json) {
            ...
            $this->session->data['inf_reg_data']['step6']['shipping_method'] = $this->session->data['shipping_methods'][$shipping[0]]['quote'][$shipping[1]];
