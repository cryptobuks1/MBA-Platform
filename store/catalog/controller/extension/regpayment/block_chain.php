...
class ControllerExtensionRegPaymentBlockchain extends Controller {
    ...
    public function index() { 
        ...
        /*if ($this->model_extension_payment_block_chain->getUnpaidAddressCount() >= 19 && $this->model_extension_payment_block_chain->getUnpaidAddress()) {
            ...
            $my_callback_url = $this->url->link('extension/regpayment/blockt_chain/blockchain_callback?invoice_id='.$invoice_id.'&secret='. $secret);
        ...
        return $this->load->view('extension/regpayment/block_chain', $data);
    }
    ...
    public function blockchain_callback() {
        $this->load->model('extension/regpayment/block_chain');
