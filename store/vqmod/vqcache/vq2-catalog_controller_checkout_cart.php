...
if ($this->cart->getProductsCount('registration')) {
                        $data['click_here'] = $this->url->link('register/user', '', true);
                    } else {
                        $data['click_here'] = $this->url->link('checkout/checkout', '', true);
                    }
				$json['success'] = sprintf($this->language->get('text_success'), $product_info['name'],$data['click_here'] , $this->url->link('checkout/cart'));
