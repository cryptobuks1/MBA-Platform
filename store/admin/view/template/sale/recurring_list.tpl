            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_date_added" value="<?php echo $filter_date_added; ?>" placeholder="<?php echo $entry_date_added; ?>" data-date-format="YYYY-MM-DD" autocomplete="off" id="input-date-date_added" class="form-control" />
