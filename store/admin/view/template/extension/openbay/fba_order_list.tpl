          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_start" value="<?php echo $filter_start; ?>" placeholder="YYYY-MM-DD" data-date-format="YYYY-MM-DD" autocomplete="off" id="input-start-date" class="form-control" />
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_end" value="<?php echo $filter_end; ?>" placeholder="YYYY-MM-DD" data-date-format="YYYY-MM-DD" autocomplete="off" id="input-end-date" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span>
                </div>
