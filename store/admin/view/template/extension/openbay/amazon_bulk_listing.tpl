          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <div class="input-group date">
                <input type="text" class="form-control" id="input-start" data-date-format="YYYY-MM-DD" autocomplete="off" placeholder="<?php echo $entry_start_selling; ?>" name="start_selling">
