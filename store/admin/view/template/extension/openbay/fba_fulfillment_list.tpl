            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_date" value="<?php echo $filter_date; ?>" placeholder="YYYY-MM-DD" data-date-format="YYYY-MM-DD" autocomplete="off" id="input-date" class="form-control" />
