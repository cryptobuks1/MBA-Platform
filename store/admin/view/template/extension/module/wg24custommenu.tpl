      ...
      <div class="panel-body">
          ...
          <div class="tab-pane">
            ...
            <div class="tab-content">
              ...
              <?php }  ?>
              <div class="form-group">
                  <label class="col-sm-12 control-label" for="url">Please you link</label>
                  <div class="col-sm-12">
                    <input type="text" name="module[url]" placeholder="URL"  value="<?php echo isset($url) ? $url: ''; ?>" class="form-control" />
                  </div>
               </div>
              <div class="form-group">
            ...
            <div class="col-sm-12">
              <select name="module[catparrent]" id="input-status" class="form-control">
               <option value="0">Root</option>
                <?php 
                foreach($allparrentcate as $cat){ $parentcat=$catparrent; ?>
                <option value="<?php echo $cat['blog_cat_id'] ?>"  <?php if($cat['blog_cat_id']==$parentcat){  echo 'selected="selected"';}else{ } ?>   ><?php echo $cat['title'] ?></option>
               <?php } ?>
              </select>
            </div>
          </div>
