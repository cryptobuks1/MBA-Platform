          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <div class="tab-content">
                  ...
                  <div class="input-group pull-left" style='margin-bottom:10px;'><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> </span>
                    <input type="text" name="banner_image[<?php echo $image_row; ?>][wg24allhomebanner_image_description][<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($banner_image['wg24allhomebanner_image_description'][$language['language_id']]) ? $banner_image['wg24allhomebanner_image_description'][$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" />
                  </div>
                   <div class="input-group pull-left" style='margin-bottom:10px;'><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> </span>
                       <textarea name="banner_image[<?php echo $image_row; ?>][wg24allhomebanner_image_description][<?php echo $language['language_id']; ?>][desce]"  placeholder="<?php echo $entry_desc; ?>" class="form-control summernote"><?php echo isset($banner_image['wg24allhomebanner_image_description'][$language['language_id']]) ? $banner_image['wg24allhomebanner_image_description'][$language['language_id']]['desce'] : ''; ?></textarea>
                  </div>
...
function addImage() {
    ...
    html += '  <td class="text-left">';
            html +=  ' <ul class="nav nav-tabs" id="language2">';
                <?php foreach ($languages as $language) { ?>
	...
	<?php foreach ($languages as $language) { ?>
           html +=  '<div class="tab-pane language<?php echo $language['language_id']; ?>" >';
	html += '    <div class="input-group" style="margin-bottom:10px;">';
	html += '      <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span><input type="text" name="banner_image[' + image_row + '][wg24allhomebanner_image_description][<?php echo $language['language_id']; ?>][title]" value="" placeholder="<?php echo $entry_title; ?>" class="form-control" />';
    html += '    </div>';
    html += '    <div class="input-group" style="margin-bottom:10px;">';
	html += '      <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span><textarea class="form-control summernote" name="banner_image[' + image_row + '][wg24allhomebanner_image_description][<?php echo $language['language_id']; ?>][desce]"  placeholder="<?php echo $entry_desc; ?>" ></textarea>';
    html += '    </div>';
     html += '    </div>';
