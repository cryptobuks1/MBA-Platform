							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<div class="input-group datetime">
											<input type="text" name="date_from" value="<?php echo date('Y-m-d'); ?>" placeholder="<?php echo $entry_date_from; ?>" data-date-format="YYYY-MM-DD" autocomplete="off" id="date-from" class="form-control" />
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<div class="input-group datetime">
											<input type="text" name="date_to" value="<?php echo date('Y-m-d'); ?>" placeholder="<?php echo $entry_date_to; ?>" data-date-format="YYYY-MM-DD" autocomplete="off" id="date-to" class="form-control" />
											<span class="input-group-btn">
												<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
											</span>
										</div>
