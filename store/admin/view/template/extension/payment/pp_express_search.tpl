        ...
        <div id="search-input">
          <form id="form" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class="input-group date">
                  <input type="text" name="date_start" value="<?php echo $date_start; ?>" placeholder="<?php echo $text_format; ?>: yy-mm-dd" data-date-format="YYYY-MM-DD" autocomplete="off" id="input-date-start" class="form-control" />
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class="input-group date">
                  <input type="text" name="date_end" value="<?php echo $date_end; ?>" placeholder="<?php echo $text_format; ?>: yy-mm-dd" data-date-format="YYYY-MM-DD" autocomplete="off" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span></div>
              </div>
