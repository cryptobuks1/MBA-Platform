 ...
 * @package		OpenCart Language German Installer
...
// Error
$_['error_exception']	= 'Fehler(%s): %s in %s Zeile %s';
...
$_['text_additional']			= '3. Zusätzlich';
$_['text_langs_available']		= 'Verfügbare Sprachen';

$_['entry_install_demo']		= 'Installiere Demodaten';
$_['entry_send_details']		= 'Sende Installationsdaten';

// Upgrade
$_['heading_upgrade']			= 'Upgrade';
$_['text_upgrade']				= 'Upgrade';
$_['text_upgrade_instructions']	= '<p><b>Nachstehende Punkte sorgfältig beachten!</b></p>
<ol>
  <li>Sollten Fehler angezeigt werden, diese im Forum veröffentlichen</li>
  <li><b>Nach dem Upgrade</b> alle Browsercookies löschen</li>
  <li>Backend aufrufen und <b>2x CTRL + F5</b> drücken um die CSS-Änderungen durchzuführen</li>
  <li>Im Backend <b>Benutzer > Benutzergruppen</b> aufrufen und alle Checkboxen der Admingruppe markieren - Speichern</li>
  <li>Im Backend die Systemeinstellungen aufrufen, alle Felder kontrollieren und speichern - auch wenn keine Änderungen sichtbar sein sollten</li>
  <li>Shop laden und <b>2x CTRL + F5</b> anwenden um die CSS-Änderungen durchzuführen</li>
</ol>';

$_['heading_upgrade_complete']	= 'Upgrade - Fertig!';
$_['text_upgrade_congrat']		= 'Glückwunsch ... Shop wurde erfolgreich aktualisiert';
$_['text_delete_install']		= 'Nicht vergessen den Installationsordner zu löschen!';

// error
$_['error_sql_file']			= 'Fehler! SQL-Datei <b>%s</b> für Datenbankeinträge nicht vorhanden';
$_['error_db_not_existing']		= 'Achtung: die Datenbank <b>%s</b> ist nicht vorhanden!';

// step 2
$_['msg_php_version']			= 'Achtung: es wird <b>PHP 5.3 oder größer</b> benötigt';
$_['msg_file_uploads']			= 'Achtung: php-Einstellung <b>file_uploads</b> muss aktiviert sein';
$_['msg_session']				= 'Achtung: <b>session.auto_start</b> muss deaktiviert sein';
$_['msg_no_db_driver']			= 'Achtung: es sind keine Datenbanktreiber (pdo,mysql,pgsql) verfügbar';
$_['msg_extension_loaded']		= 'Achtung: die Erweiterung <b>%s</b> muss geladen sein';
$_['msg_no_config']				= 'Achtung: die Datei <b>%s</b> ist nicht vorhanden. Entweder neu erstellen oder vorhandene config-dist.php umbenennen';
$_['msg_file_writeable']		= 'Achtung: die Datei <b>%s</b> muss für die Installation beschreibbar sein';

// step 3
$_['text_invoice_prefix']		= 'RE';

// email
$_['email_subject']				= 'Neue Shopinstallation auf %s';
$_['email_body']				= 'Benutzername: %s<br />Passwort: %s<br />Datenbankhostname: %s<br />Datenbankbenutzername: %s<br />Datenbankpasswort: %s<br />Datenbankname: %s<br />Demodaten installiert: %s';
$_['text_yes']					= 'Ja';
$_['text_no']					= 'Nein';
/** + OSWorX end */

// Heading
$_['heading_step_1']		= 'Lizenz';
$_['heading_step_1_small']	= 'Bitte nachstehende Lizenz sorgfältig lesen';
$_['heading_step_2']		= 'Schritt 2';
$_['heading_step_2_small']	= 'Servereinstellungen';
$_['heading_step_3']		= 'Konfiguration';
$_['heading_step_3_small']	= 'Datenbank- &amp; Admindetails';
$_['heading_step_4']		= 'Installation fertig';
$_['heading_step_4_small']	= 'Bereit zum verkaufen!';
$_['heading_maxmind']		= 'MaxMind';
$_['heading_maxmind_small']	= 'Betrugserkennung';
$_['heading_openbay']		= 'OpenBay Pro';
$_['heading_openbay_small']	= 'Mehrere Markplätze integrieren';

// Text
$_['text_license']			= 'Lizenz';
$_['text_installation']		= 'Umgebung';
...
$_['text_install_file']		= '3. <b>Konfigurationsdateien</b><br />(falls noch nicht gemacht, beide Dateien müssen <b>config.php</b> heißen.<br />Wenn notwendig anpassen bzw. erstellen &amp; Seite neu laden)';
$_['text_install_directory']= '4. <b>Ordnerrechte</b><br />(wenn notwendig anpassen &amp; Seite neu laden)';
$_['text_db_connection']	= '<b>1. Datenbankdetails</b> <small>(Falls nicht bekannt, bitte bei Provider nachfragen)</small>';
$_['text_db_administration']= '<b>2. Verwaltung</b> <small>(Anmeldung im Verwaltungsbereich)</small>';
$_['text_congratulation']	= 'Gratulation ... Shop wurde erfolgreich installiert';
$_['text_setting']			= 'PHP Einstellungen';
$_['text_current']			= 'Aktuell';
$_['text_required']			= 'Benötigt';
$_['text_extension']		= 'Erweiterungen';
$_['text_database']			= 'Basis';
$_['text_file']				= 'Dateien';
$_['text_directory']		= 'Ordner';
$_['text_status']			= 'Status';
$_['text_version']			= 'PHP Version';
$_['text_global']			= 'Register Globals';
$_['text_magic']			= 'Magic Quotes GPC';
$_['text_upload']			= 'Dateiuploads';
...
$_['text_forget']			= 'Nicht vergessen den Installationsordner entweder zu löschen oder umzubenennen (dann auch Rechte auf 0644 setzen)!';
$_['text_shop']				= 'Zum Shop';
$_['text_login']			= 'Zur Administration';
$_['text_project']			= 'Projektseite';
$_['text_documentation']	= 'Dokumentation';
$_['text_support']			= 'Supportforen</a> |<a href="http://osworx.net" target="_blank">OSWorX';
$_['text_footer']			= 'Copyright © ' . date( 'Y' ) . ' OpenCart - All rights reserved<br />Dt. Version by <a href="http://osworx.net" target="_blank">OSWorX.net</a>';
$_['text_loading']			= 'Lade Module ...';
$_['text_store']			= 'Erweiterungsshop besuchen';
$_['text_mail_list']		= 'Mailingliste abonnieren';
$_['text_mail_list_small']	= 'Über Updates &amp; Events von OpenCart informiert bleiben';
...
$_['text_facebook_info']	= 'Wie gefällt OpenCart?';
$_['text_facebook_link']	= 'Facebookseite besuchen';
$_['text_forum']			= 'Foren';
$_['text_forum_info']		= 'Hilfe von anderen Benutzern erhalten';
$_['text_forum_link']		= 'Foren besuchen';
$_['text_commercial']		= 'Kommerzielle Hilfe';
$_['text_commercial_info']	= 'Entwicklerdienste von Partnern';
$_['text_commercial_link']	= 'Partnerseite besuchen';
$_['text_view']				= 'Details anzeigen';
$_['text_download']			= 'Download';
$_['text_downloads']		= 'Downloads';
$_['text_price']			= 'Preis';
$_['text_view']				= 'Details anzeigen';
$_['text_maxmind_success']	= 'MaxMind wurde erfolgreich installiert';
$_['text_maxmind_top']		= 'Falls kein Lizenschlüssel vorhanden ist, kann er';
$_['text_maxmind_link']		= 'hier bestellt werden';
$_['text_ebay_about']		= 'eBay ist ein internationaler Markplatz für Private und Geschäfte';
$_['text_amazon_about']		= 'Amazon Marktplatz ist ausgerichtet auf fixe Preise für neue &amp; gebrauchte Artikel';
$_['text_file_upload']		= 'Dateien hochladen';

// Entry
$_['entry_db_driver']		= 'Datenbanktreiber';
$_['entry_db_hostname']		= 'DB Hostname';
$_['entry_db_username']		= 'DB Benutzername';
$_['entry_db_password']		= 'DB Passwort';
$_['entry_db_database']		= 'Datenbank';
$_['entry_db_prefix']		= 'DB Vorzeichen';
$_['entry_db_port']			= 'Portnr.';
$_['entry_username']		= 'Benutzername <small>(nicht admin udgl.)</small>';
$_['entry_password']		= 'Passwort';
$_['entry_email']			= 'Email';
$_['entry_key']				= 'Lizenzschlüssel';
$_['entry_score']			= 'Risikowert';
$_['entry_order_status']	= 'Status bei mögl. Betrug';
	// older < 2.1
$_['entry_licence_key']		= 'Lizenzschlüssel';
$_['entry_risk']			= 'Risikowert';
$_['entry_fraud_status']	= 'Status bei mögl. Betrug';

// Help
$_['help_score']			= 'Je höher der Wert desto mehr kann die Bestellung ein Betrug sein. Wert zwischen 0 und 100 verwenden';
$_['help_order_status']		= 'Bestellungen mit einem höheren Wert als angegeben werden mit dem Auftragsstatus gespeichert und können nicht automatisch abgeschlossen werden.';
	// older < 2.1
$_['help_maxmind_risk']		= 'Je höher der Wert desto mehr kann die Bestellung ein Betrug sein. Wert zwischen 0 und 100 verwenden';
$_['help_maxmind_fraud']	= 'Bestellungen mit einem höheren Wert als angegeben werden mit dem Auftragsstatus gespeichert und können nicht automatisch abgeschlossen werden.';

// Error
$_['error_key']				= 'Maxmindlizenz wird benötigt';
$_['error_score']			= 'Wert zwischen 0 und 100 ist möglich';
...
$_['button_continue']		= 'Weiter';
$_['button_back']			= 'Zurück';
$_['button_join']			= 'Hier abonnieren';
$_['button_setup']			= 'Jetzt registrieren';
$_['button_register']		= 'Registrieren';
$_['button_register_eu']	= 'Europa';
$_['button_register_us']	= 'USA';

$_['text_terms'] = '<p>Deutsche Übersetzung der Version 3, 29. Juni 2007</p>
<p>Der offizielle englische Originaltext befindet sich unter <a href="http://www.gnu.org/licenses/gpl.html" target="_blank">www.gnu.org</a>.
<br />
...
<p>Es folgen die präzisen Bedingungen für das Kopieren, Verbreiten und Modifizieren.</p>
<p>
LIZENZBEDINGUNGEN
</p>
<p>
...
<br />
c) 	das Verbot, die Herkunft des Materials falsch darzustellen oder die Anforderung, daß modifizierte Versionen des Materials auf angemessene Weise als vom Original verschieden markiert werden, oder
<br />
