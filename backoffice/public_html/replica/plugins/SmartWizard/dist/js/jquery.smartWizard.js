...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnGroup = $('<div></div>').addClass('btn-group navbar-btn sw-btn-group -' + this.options.toolbarSettings.toolbarButtonPosition).attr('role', 'group').append(btnPrevious, btnNext,btnGroupExtra);


            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                btnGroupExtra = $('<div></div>').addClass('btn-group navbar-btn sw-btn-group-extra -' + this.options.toolbarSettings.toolbarButtonPosition).attr('role', 'group');
