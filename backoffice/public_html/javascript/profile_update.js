...
$(function() {
    ...
    $("#ifsc,#pan,#blockchain_account,#account_no,#bitgo_account,#acnumber_australian,#bsb").on('keypress', function(e) {
    ...
    $('#update_bank_info').on('click', function(i, k) {
        ...
        if ($('#bank_name,#branch_name,#account_holder,#nacct_australian_holder,#account_no,#acnumber_australian,#ifsc,#pan').valid()) {
            var res = loadModal(this.id, k);
            if (!res) {
                return;
            }
