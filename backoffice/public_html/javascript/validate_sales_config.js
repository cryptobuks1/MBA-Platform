...
var ValidateConfiguration = function() {
    if (input_group_showed) {
        $('.rank_percentage,.level_percentage,.pck_percentage').parent('.input-group').addClass('input-group-hide');
    }
    ...
    var runValidateConfig = function() {
        var msg9 = $("#upto_level_sales").html();
