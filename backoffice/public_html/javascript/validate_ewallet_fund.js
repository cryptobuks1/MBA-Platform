...
var ValidateFund = function() {
    ...
    var msg14 = $("#error_amount").html();
     var msg15 = $("#msg4").html();
    var msg16 = $("#trans_pass_req").html();
    var msg17= $("#greater_than_0").html();
    var msg18=$("#invalid_amount").html();
    var msg19=$("#validate_msg1").html();
    var runValidateFundSelection = function() {
        $.validator.addMethod("balance_check", function(value, element) {
            ...
            if ($('#blnc').length != 0) {
                ...
                tot_val2 =  Number(trans_amount);
                var balance3 = Number(balance);


                if (Number(tot_val) <= balance2) {
                    $flag = 1;
                }
                if (Number(tot_val2) <= balance3) {
                    $flag = 1;
                }
            }
            return $flag;
        ...
        $.validator.addMethod("multiple_check", function(value, element) {
            $flag = 0;
            if ($('#subs_fee').length != 0) {
                var trans_amount = ($('#subs_fee').val());
                var subscription_amount = ($('#subscription_amount').val());
                 if(trans_amount % subscription_amount == 0 ){
                    $flag=1;
                 } 
            }
            return $flag;
