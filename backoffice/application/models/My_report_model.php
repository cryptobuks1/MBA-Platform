...
class my_report_model extends inf_model
{
    ...
    {
        $arr = $this->getDownlineBinary($id, 'left_father', 'right_father', $limit, $page, 'binary', $level_value);
        return $arr;
    }
    ...
    public function getDownlineBinary($user_id, $left_field, $right_field, $limit, $page = 0, $plan = 'binary', $level_value = '')
    {
    ...
    public function getTotalDownlineUsersBinary($user_id, $left_field, $right_field, $plan = 'binary', $level_value = '')
    {
