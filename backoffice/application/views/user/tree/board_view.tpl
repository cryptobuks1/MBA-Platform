...
<div class="panel panel-default m-t">
    <div class="panel-body">
        ...
        <a href="{BASE_URL}/user/view_board_details/{$board_id}" class="pull-right btn m-b-xs btn-sm btn-info btn-addon"><i class="fa fa-backward"></i>{lang('back')}</a>
    </div>
</div>
...
{if $table_status}
    {include file="user/tree/table_view.tpl"}
{else}
    {include file="user/tree/tree_view_board.tpl"}
{/if}
