            ...
            <div class="body_text_tree">
                ...
                <ul class="list-group no-radius">
                    ...
                    {/if}
                         ...
                         {if $tooltip_config['downline_count'] == 'yes'}
                        <li class="list-group-item">
                            <div class="pull-right">{$v['left_user_count']|default:0}</div>
                            <div class="pull-left">{lang('left_user_count')}:</div>
                        </li>
                        <li class="list-group-item">
                            <div class="pull-right">{$v['right_user_count']|default:0}</div>
                            <div class="pull-left">{lang('right_user_count')}:</div>
                        </li>
                    {/if}
                    ...
                    {if $tooltip_config['rank_status'] == 'yes'}
                        ...
                        <li class="list-group-item">
                            <div class="pull-right">{$v['monthly_rank_pv']|default:0}</div>
                            <div class="pull-left">{lang('monthly_rank_pv')}:</div>
                        </li>
                    {/if}
                    {if $MODULE_STATUS['mlm_plan'] == 'Donation' && $v['donation_level']}
                        ...
                        {/if}
                    {/if}
                  {if $tooltip_config['subscription_end_date'] == 'yes'}
                        <li class="list-group-item">
                            <div class="pull-right">{date('Y/m/d', strtotime($v['subs_end_date']))}</div>
                            <div class="pull-left">{lang('subscription_end_date')}:</div>
                        </li>
                    {/if}
                    ...
                    {if $tooltip_config['join_type']=="yes" && $v['join_type']=="customer" &&  $v['rank_id']==NULL}
                                ...
                                <div class="tooltip_rank" style="background-color:{$v['rank_color']}">{if $v['join_type']=='customer'}
                                {lang('customer')}
                                {/if}</div>
