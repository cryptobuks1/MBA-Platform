    ...
    <div class="panel panel-default table-responsive ng-scope">
        <table st-table="rowCollectionBasic" class="table table-bordered table-striped">
            ...
            {if $details_count > 0}
                ...
                {$i = 0}
                {foreach from=$active_deposit item=v}
                    ...
                    <tr>
                        ...
                        <td style="font-size: initial;">{$DEFAULT_SYMBOL_LEFT}{number_format($active_deposit[$i-1]['tot_amount']*$DEFAULT_CURRENCY_VALUE,$PRECISION)}{$DEFAULT_SYMBOL_RIGHT}</td>
                    </tr>
                </tbody>
            {else}
                <tbody>
