...
<div id="span_js_messages" style="display:none;">
    ...
    <span id="msg13">{lang('main_matter_is_required')}</span>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title"> {lang('top_banner')}
                            <!-- <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab">
                    ...
                    <!-- <div id="tab" class="panel-collapse panel-collapse collapse"> -->
                        <div class="panel-body">
                            {form_open_multipart('user/replica_configuration','role="form" class=""
                            name="upload_materials" id="upload_materials1"')}
                ...
                {* <div class="panel panel-default">
                    ...
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-1">
                        <h4 class="panel-title"> {lang('moving_banner')}
                            <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab-1">
                                <i class="glyphicon glyphicon-chevron-down"></i> </span>
                        </h4>
                        </a>
                    </div>
                    <div id="tab-1" class="panel-collapse panel-collapse collapse">
                        <div class="panel-body">
                            {form_open_multipart('user/replica_configuration','role="form" class="smart-wizard"
                            name="upload_materials" id="upload_materials1"')}
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                {else}
                                <input class="form-control" type="text" value="mlm-world-mlm-software-development.jpg" readonly='true'
                            ...
                            <div class="form-group">
                                ...
                                <span class="help-block m-b-none">{lang('please_choose_a_png_file.')}</span>
                                <span class="help-block m-b-none">{lang('max_size_20MB')}</span>
                            </div>
                            ...
                            <div class="form-group">
                                <button class="btn btn-sm btn-primary" name="submit_movbanner" id="submit_movbanner" type="submit"
                                    value="submit">{lang('upload')}</button>
                            </div>
                ...
                {* <div class="panel panel-default">
                    ...
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-3">
                        <h4 class="panel-title"> {lang('content_management')}
                            <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab-3">
                                <i class="glyphicon glyphicon-chevron-down"></i> </span>
                        </h4>
                        </a>
                    </div>
                    <div id="tab-3" class="panel-collapse panel-collapse collapse">
                        <div class="panel-body">
                            {form_open_multipart('user/replica_configuration','role="form" class="" name=
                            "content_form" id="content_form"')}
                            {include file="layout/error_box.tpl"}
                            <div class="form-group">
                                <label class="control-label required" for="subtitle">{lang('sub_title')}</label>
                                <input class="ckeditor form-control" id="subtitle" name="subtitle" title="{lang('main_matter')}" value="{$subtitle}">
                                {form_error('subtitle')}
                            </div>
                
                            <div class="form-group">
                                <label class="control-label required" for="replica_content_main">{lang('main_matter')}</label>
                                <textarea class="ckeditor form-control" id="replica_content_main" name="replica_content_main" title="{lang('main_matter')}"
                                    rows="6">{$description}</textarea>
                                {form_error('replica_content_main')}
                            </div>
                
                            <div class="form-group">
                                <button class="btn btn-sm btn-primary" name="replica_content" id="replica_content" type="submit" value="{lang('update')}">
                                    {lang('update')}</button>
                            </div>
                            {form_close()}
                        </div>
                ...
                {* <div class="panel panel-default">
                    ...
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-4">
                        <h4 class="panel-title"> 
                                {lang('video_banner')}
                            <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab-4">
                                <i class="glyphicon glyphicon-chevron-down"></i> </span>
                        </h4>
                        </a>
                    </div>
                    <div id="tab-4" class="panel-collapse panel-collapse collapse">
                        <div class="panel-body">
                            {form_open_multipart('user/replica_configuration','role="form" class="smart-wizard"
                            name="youtube_profile" id="youtube_profile"')}
                            {include file="layout/error_box.tpl"}
                            <div class="form-group">
                                <label class="control-label required" for="new_passcode">{lang('Enter Youtube link')}</label>
                                <input class="form-control" type="text" name="banner_link" id="banner_link" {if
                                    isset($content['video'])}value="{$content['video']}" {else}value="https://www.youtube.com/watch?v=zd92vBBv1r8"
                                    {/if} />
                ...
                {* <div class="panel panel-default">
                    ...
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-5">
                        <h4 class="panel-title"> {lang('social_profile')}
                            <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab-5">
                                <i class="glyphicon glyphicon-chevron-down"></i> </span>
                        </h4>
                        </a>
                    </div>
                    <div id="tab-5" class="panel-collapse panel-collapse collapse">
                        <div class="panel-body">
                            {form_open_multipart('user/replica_configuration','role="form" class="smart-wizard"
                            name="socail_profile11" id="socail_profile11"')}
                            {include file="layout/error_box.tpl"}
                            <div class="form-group">
                                <label class=" control-label" for="new_passcode">{lang('facebook')}</label>
                                <input class="form-control" type="text" name="facebook" id="facebook" {if
                                    isset($content['facebook'])}value="{$content['facebook']}" {/if}/> {form_error('facebook')} <span
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="twitter" id="twitter" {if
                                    isset($content['twitter'])}value="{$content['twitter']}" {/if} />
                                {form_error('twitter')}
                                <span class="help-block"></span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="linkedin" id="linkedin" {if
                                    isset($content['linkedin'])}value="{$content['linkedin']}" {/if}/> {form_error('linkedin')} <span
                                    class="help-block"></span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="google_plus" id="google_plus" {if
                                    isset($content['google_plus'])}value="{$content['google_plus']}" {/if}/>
                                    {form_error('google_plus')} <span class="help-block"></span>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="youtube" id="youtube" {if
                                    isset($content['youtube'])}value="{$content['youtube']}" {/if}/> {form_error('youtube')} <span
                                    class="help-block"></span>
                                <p style="color: #737373;">{lang('Eg:https://www.youtube.com/example.')}</p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="instagram" id="instagram" {if
                                    isset($content['instagram'])}value="{$content['instagram']}" {/if}/> {form_error('instagram')}
                                    <span class="help-block"></span>
                ...
                {*<div class="panel panel-default">
                    ...
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-6">
                        <h4 class="panel-title"> 
                            ...
                            <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab-6">
                                <i class="glyphicon glyphicon-chevron-down"></i> </span>
                        </h4>
                        </a>
                    </div>
                    {form_open_multipart('user/replica_configuration','role="form" class="" name= "terms_form"
                    id="terms_form"')}
                    <div id="tab-6" class="panel-collapse panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control" id="content_terms" name="content_terms" title="{lang('main_matter')}"
                                    rows="6">{if isset($content['terms'])}{$content['terms']}{else}
                            ...
                            <div class="form-group">
                                <button class="btn btn-sm btn-primary" name="submit_term" id="submit_term" type="submit" value="{lang('update')}">
                                    {lang('update')}</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                     <a data-toggle="collapse" data-parent="#accordion" href="#tab-7">
                        <h4 class="panel-title">{lang('privacy_policy')}
                            <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab-7">
                                <i class="glyphicon glyphicon-chevron-down"></i> </span>
                        </h4>
                        </a>
                    </div>
                    {form_open_multipart('user/replica_configuration','role="form" class="" name= "policy_form"
                    id="policy_form"')}
                    <div id="tab-7" class="panel-collapse panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="txtDefaultHtmlArea">{lang('main_matter')}</label>
                                <textarea class="ckeditor form-control" id="content_policy" name="content_policy" title="{lang('main_matter')}"
                                    rows="6">{if isset($content['policy'])}{$content['policy']}{else}
                            ...
                            <div class="form-group">
                                <button class="btn btn-sm btn-primary" name="submit_policy" id="submit_policy" type="submit" value="{lang('update')}">
                                    {lang('update')}</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel panel-default">
                    ...
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-8">
                        <h4 class="panel-title"> {lang('about_us')}
                            <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab-8">
                                <i class="glyphicon glyphicon-chevron-down"></i> </span>
                        </h4>
                        </a>
                    </div>
                    {form_open_multipart('user/replica_configuration','role="form" class="" name= "about_form"
                    id="about_form"')}
                    <div id="tab-8" class="panel-collapse panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="txtDefaultHtmlArea">{lang('main_matter')}</label>
                                <textarea class="ckeditor form-control" id="content_about" name="content_about" title="{lang('about_us')}"
                                    rows="6">{if isset($content['about_us'])}{$content['about_us']}{else}
                            ...
                            <div class="form-group">
                                <button class="btn btn-sm btn-primary" name="submit_about" id="submit_policy" type="submit" value="{lang('update')}">
                                    {lang('update')}</button>
                            </div>
                        </div>
                    </div>
                ...
                {*<div class="panel panel-default">
                    ...
                    <a data-toggle="collapse" data-parent="#accordion" href="#tab-9">
                        <h4 class="panel-title"> {lang('contact_us')}
                            <span class="pull-right panel-collapse-clickable" data-toggle="collapse" data-parent="#accordion" href="#tab-9">
                                <i class="glyphicon glyphicon-chevron-down"></i> </span>
                        </h4>
                        </a>
                    </div>
                    {form_open_multipart('user/replica_configuration','role="form" class="" name=
                    "address_form" id="address_form"')}
                    <div id="tab-9" class="panel-collapse panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <button class="btn btn-sm btn-primary" name="submit_address" id="submit_about" type="submit" value="{lang('update')}">
                                    {lang('update')}</button>
                            </div>
                        </div>
                    </div>
