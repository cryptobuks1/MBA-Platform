...
<div class="panel panel-default">
    <div class="panel-body">
        {form_open('user/commission_report_view','role="form" class="" method="post" name="commision_form" id="commision_form" target="_blank" onsubmit="return validation()"')}
        ...
        <div class="form-group credit_debit_button">
            <button class="btn btn-primary mark_paid" name="commision" type="submit" value="{lang('submit')}">
                {lang('submit')}</button>
        </div>
        {form_close()}
    </div>
