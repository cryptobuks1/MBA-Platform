...
<div class="panel panel-default">
    ...
    <legend><span class="fieldset-legend">{lang('sales_report')}</span></legend>
        {form_open('user/sales_report_view','role="form" class="" method="post" name="sales_report" id="weekly_payout" target="_blank" onsubmit = "return dateValidation()"')} {include file="layout/error_box.tpl"}
...
<div class="panel panel-default">
    ...
    <legend><span class="fieldset-legend">{lang('product_wise_sales_report')} : {lang('register')}</span></legend>
        {form_open('user/product_sales_report','role="form" class="" method="post" name="user" id="user" target="_blank"')} {include file="layout/error_box.tpl"}
        <div class="col-sm-3 padding_both">
            <div class="form-group">
...
<div class="panel panel-default">
    ...
    <legend><span class="fieldset-legend">{lang('product_wise_sales_report')} : {lang('repurchase')}</span></legend>
        {form_open('user/product_sales_report','role="form" class="" method="post" name="user" id="rp_user" target="_blank"')} {include file="layout/error_box.tpl"}
        <div class="col-sm-3 padding_both">
            <div class="form-group">
                <label class="required" for="product_id">{lang('select_package')}</label>
                <select name="product_id" id="product_id" onChange="change_product(this);" class="form-control">
