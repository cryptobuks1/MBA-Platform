...
<div class="panel panel-default">
  ...
  <legend><span class="fieldset-legend">{lang('payout_release_reports')}</span></legend>
    {form_open('user/payout_released_report_daily','role="form" class="" method="post" name="searchform" id="searchform"  target="_blank"')}
...
<div class="panel panel-default">
  <div class="panel-body">
  <legend><span class="fieldset-legend">{lang('payout_release_reports')}</span></legend>
    {form_open('user/payout_released_report_weekly','role="form" class="" method="post" name="searchform2" id="searchform2"  target="_blank"')}
      <div class="col-sm-3 padding_both">
      <div class="form-group">
...
<div class="panel panel-default">
  ...
  <legend><span class="fieldset-legend">{lang('payout_pending_report')}</span></legend>
    {form_open('user/payout_pending_report_weekly','role="form" class="" method="post" name="searchform1" id="searchform1"  target="_blank"')}
      <div class="col-sm-3 padding_both">
      <div class="form-group">
