...
</script>{/block} {block name=$CONTENT_BLOCK} {assign var="excel_url" value="{$BASE_URL}user/excel/exelPersonalDtaExport"} {assign var="csv_url" value="{$BASE_URL}user/excel/personalDtaExport"} {assign var="report_name" value="{lang('personal_data_report')}"}{include
file="user/report/report_nav.tpl" name=""}
<div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-full-width table-bordered" id="sample_1">
                        ...
                        <tbody>
                            {assign var="root" value="{$BASE_URL}user/"} {$i = 0} {foreach from=$details["activity"] item=v}
                            <tr>
                                <td>{$i + $page_id + 1}</td>
                                <td>{$v.date}</td>
                                <td>{$v.ip}</td>
