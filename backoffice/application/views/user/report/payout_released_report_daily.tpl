{extends file=$BASE_TEMPLATE} {block name=$CONTENT_BLOCK}{assign var="excel_url" value="{$BASE_URL}user/excel/create_excel_payout_released_report_daily"} {assign var="csv_url" value="{$BASE_URL}user/excel/create_csv_payout_released_report_daily"}
