{extends file=$BASE_TEMPLATE} {block name=$CONTENT_BLOCK}{assign var="excel_url" value="{$BASE_URL}user/excel/create_excel_commission_report/{$user_name}"} {assign var="csv_url" value="{$BASE_URL}user/excel/create_csv_commission_report/{$user_name}"}
