{form_open('user/member/package_validity_submit', 'role="form" class="" method="post"  name="form" id="form"')}
                ...
                <div class="bhoechie-tab-content {if $active_tab_val=='ewallet_tab'}active{/if}">
                    <div class="content">
                        <div class="row col-sm-12">
                            ...
                            <div class="mark_paid col-sm-5 padding_both_small" id="check_ewallet_button">
                                <div class="form-group">
