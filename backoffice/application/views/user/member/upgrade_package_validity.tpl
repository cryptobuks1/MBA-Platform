        ...
        <div class="col-lg-12">
            ...
            {else}
                {if count($expired_users)>0}
                    ...
                    <div class="col-lg-5 col-sm-offset-1 b-r ">
                        <div class="clearfix text-center">
                            <div class="inline">
                                ...
                                <div class="h4 m-b-xs">{$user_name}</div> 
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <table class="table table-responsive boder_none_modal">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="width_name_space_dot">:</td>
                                    <td> <td>{$DEFAULT_SYMBOL_LEFT} {number_format($product_amount*$DEFAULT_CURRENCY_VALUE,$PRECISION)} {$DEFAULT_SYMBOL_RIGHT}</td></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    {else}
                    <tbody>
                        <tr><td colspan="8" align="center"><h4 align="center"> {lang('You_are_on_Active_period')}</h4></td></tr>
                    </tbody>
                    {/if}
                    {/if}
                </div>
