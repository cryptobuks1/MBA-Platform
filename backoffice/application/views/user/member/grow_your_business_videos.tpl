        ...
        <div class="content">
            ...
            {foreach $videos as $video }
                <div class="videos-grid-video">
                    <div>
                <iframe width="100%" height="80%" src="https://player.vimeo.com/video/{substr($video['video_link'], 8)}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                </div>
