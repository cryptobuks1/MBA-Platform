...
{block name=$CONTENT_BLOCK}
    {form_open('register/sofort_response', 'method="post" class="" name="form" id="form" role="form"')}
    <div class="panel panel-default table-responsive">
        <table st-table="rowCollectionBasic" class="table">
            ...
            <input type="hidden" name="success_url" id="success_url" value="{$PATH_TO_ROOT_DOMAIN}register/sofort_success">
            <input type="hidden" name="abort_url"  id="abort_url" value="{$PATH_TO_ROOT_DOMAIN}register/user_register">
       <tr>
            {if $DEMO_STATUS == 'yes'}
